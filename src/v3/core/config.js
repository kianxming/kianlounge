...
export const PREFS={
 luffy:{restaurant:10,square:6,lodge:4,dojo:4,tavern:2,shop:1},zoro:{dojo:10,tavern:8,bath:4,restaurant:4,lodge:3},
 sanji:{restaurant:8,square:5,shop:4,lodge:3,dojo:4},nami:{shop:9,restaurant:5,square:5,bath:5,tavern:4},
 usopp:{shop:7,square:7,restaurant:6,dojo:3,lodge:4},chopper:{clinic:10,restaurant:6,square:6,lodge:5},
 robin:{square:8,restaurant:5,lodge:6,bath:5},franky:{shop:8,dojo:7,restaurant:5,square:4}
};
